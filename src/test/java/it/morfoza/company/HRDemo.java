...
public class HRDemo {
    ...
    private static Employee otherGenderEmployee() {return createEmployeeWithBothGenderSetTo(Gender.FEMALE);}

    private static Employee otherGenderEmployee1() {return createEmployeeWithBothGenderSetTo(Gender.MALE);}

    private static Employee otherGenderEmployee2() {return createEmployeeWithBothGenderSetTo(Gender.NEITHER);}
